                     ...
                     _In_ int       nCmdShow)
{
	...
	LoadString(hInstance, IDC_GAMEKILLERPACMAN, szWindowClass, MAX_LOADSTRING);
	...
	hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_GAMEKILLERPACMAN));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.lpszMenuName	= MAKEINTRESOURCE(IDC_GAMEKILLERPACMAN);
